...
compile: parser lexer CodeGenerator.o Command.o Variable.o Array.o ArrayAddress.o Constant.o Memory.o
	g++ -g3 -o compiler parser.tab.cpp lex.yy.c -lfl CodeGenerator.o Command.o Variable.o Array.o ArrayAddress.o Constant.o Memory.o
